...
var index = 0
@export var ForceUpdate: bool: set = forceUpdate
@export var PadZeroes: bool
@export var GenerateAllPalettes: bool
@export var TileSize: Vector2 = Vector2(16,16): set = changeTileSize
@export var Separation: Vector2 = Vector2(0,0): set = changeSeparation
